              ...
              <div className="border border-gray-100 shadow rounded-lg bg-white w-full flex items-center p-6 gap-2">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    <p>Hello !</p>
                    <p>
                      I have seemingly metamask related problems when executing
                      one function of one of our contracts.
                    </p>
                    <p>
                    ...
                    <p>
                      I can basically call every function of this contract, but
                      the approve function. Calling the approve function trigger
                      metamask, and then, it get stuck on the loading screen
                      right before allowing us to confirm the transaction.
                    </p>
                    ...
                    <p>
                      ...
                      10.0.0 and it worked fine. But no luck with the 10.13.0
                      one.
                    </p>
                    ...
                    <p>
                      ...
                      let&apos; say “approveMe”, without changing a thing in it,
                      it go through.
                    </p>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="space-y-3 flex-1">
                    ...
                    <p>
                      ...
                      haven&apos;t received any codes to successfully set up my
                      wallet.
                    </p>
                    <p>Can anyone assist me with this issue? Help, please!</p>
